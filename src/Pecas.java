...
public class Pecas {
	...
	public void posicionaPeaoNaCoord(Jogador jogador, int numPeao) {
		Peao p = jogador.peaodoJogador(numPeao);
		String cor = p.corDoPeoa();
		int i, qtd = 0;
		
		// Verifica se a casa ta aberta
	...
	// Jogo Modo Duplas
		public void posicionaPeaoNaCoord(Jogador jogador, int numPeao, Jogador parceiro) {
			Peao p = jogador.peaodoJogador(numPeao);
			String cor = p.corDoPeoa();
	...
	public void posicionaMetaNaCoord(Meta m) {
		meta = m;
		return;
	}
